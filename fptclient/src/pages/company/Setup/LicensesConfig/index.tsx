...
import { useBulkDeleteCompanyLicenses, useGetCompanyLicenses } from 'libs/hooks/api/company/useCompanyLicense';
...
const LicensesConfig = () => {
  ...
  const handleCreateUpdate = (license?: License) => {
    openModal({
      content: <ModalCompanyLicense license={license} screen={screen} />,
      options: {
  ...
  return (
    <>
      <HeaderTable
        title={`${t('field_management', { field: t('license') })}`}
