...
import { AddLicenseByAdminReq, License, QueryParamsType, UpdateLicenseReq } from 'types/SwaggerTypeAdmin';

const baseUrl = 'admin/v1/license/';
const url = {
...
const useCreateCompanyLicense = () => {
  ...
  return useMutation({
    mutationFn: (body: Partial<AddLicenseByAdminReq>): Promise<BaseResponse<License>> => {
      return fetcher({
